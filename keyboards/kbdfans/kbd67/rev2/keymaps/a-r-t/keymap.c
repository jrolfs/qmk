...
[_FN2] = LAYOUT_all(
  ...
  _______, XXXXXXX, _______, P_XMAS,  P_CAROLINE, _______, _______, _______, _______, _______, _______, _______, /**/     _______, _______, _______, \
...
bool process_record_keymap(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case P_CAROLINE:
            if (record->event.pressed) {
                SEND_STRING("say Merry Christmas Caroline!\r");
            }
            break;
    }
