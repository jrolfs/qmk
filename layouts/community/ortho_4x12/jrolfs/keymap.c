...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FUNCTION] = LAYOUT_ortho_4x12( \
    _______, _______, _______,  _______,  _______, _______, _______, _______, _______, _______, _______, _______, \
    _______, RGB_TOG, RGB_RMOD, RGB_MOD,  _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, \
    _______, OUT_AUTO, OUT_USB, OUT_BT,   _______, _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, _______,  KC_SLCK,  KC_PAUS, _______, _______, _______, _______, _______, _______, _______
  ),
};
