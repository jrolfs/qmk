...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_ortho_4x12( \
    ...
    FUNCTION, KC_LCTL, KC_LALT, KC_LGUI, LOWER, KC_SPC, KC_SPC, RAISE, KC_RGUI, KC_RALT, KC_RCTL, FUNCTION
  ),
  ...
  [_LOWER] = LAYOUT_ortho_4x12( \
    ...
    _______, _______, _______, _______, _______, KC_PGDN, KC_PGDN, _______, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR
  ),
  ...
  [_BOTH] = LAYOUT_ortho_4x12( \
    RGB_HUI, RGB_SAI, RGB_VAI, _______, KC_RESET, _______,  _______, _______, RGB_M_P,  RGB_M_B, RGB_M_R, RGB_M_SW, \
    RGB_HUD, RGB_SAD, RGB_VAD, _______, RGB_TOG,  RGB_RMOD, RGB_MOD, _______, RGB_M_SN, RGB_M_K, RGB_M_X, RGB_M_G,  \
    _______, _______, _______, _______, OUT_AUTO, OUT_USB,  OUT_BT,  _______, _______,  _______, _______, _______,  \
    _______, _______, _______, _______, _______,  _______,  _______, _______, BL_DEC,   BL_INC,  _______, BL_TOGG
  ),

  [_FUNCTION] = LAYOUT_ortho_4x12( \
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
    KC_SLCK, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, \
    KC_PAUS, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  \
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
  ),
};
